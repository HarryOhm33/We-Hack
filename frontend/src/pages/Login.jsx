  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-black overflow-hidden">
      ...
      <div className="bg-gray-900 text-white p-8 rounded-2xl shadow-xl w-96 border border-gray-700 relative z-10 flex flex-col items-center overflow-hidden">
        ...
        <h2 className="text-4xl font-bold mb-6 text-pink-400 relative z-20 text-center w-full">Welcome!</h2>
        
        <form action="#" method="POST" className="space-y-6 relative z-20 w-full flex flex-col items-center">
        ...
        <div className="mt-6 flex justify-between text-sm relative z-20 w-full">
          <a href="#" className="text-pink-400 hover:text-pink-300 transition-all underline">Sign up</a>
          <a href="#" className="text-purple-400 hover:text-purple-300 transition-all underline">Forgot Password?</a>
        </div>
      </div>
    </div>
  );
